...
public class DebugServerException extends RuntimeException {
  private static final String GENERIC_ERROR_MESSAGE =
      ...
      "\u2022 If you're on a physical device connected to the same machine, run 'adb reverse tcp:40257 tcp:40257' to forward requests from your device\n" +
      "\u2022 If your device is on the same Wi-Fi network, set 'Debug server host & port for device' in 'Dev settings' to your machine's IP address and the port of the local dev server - e.g. 10.0.1.1:40257\n\n";
